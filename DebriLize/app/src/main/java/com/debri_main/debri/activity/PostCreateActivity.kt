...
import com.debri_main.debri.data.post.Post
import com.debri_main.debri.service.PostService
import com.debri_main.debri.view.post.PostCreateView
import com.debri_main.debri.databinding.ActivityPostCreateBinding
import com.debri_main.debri.utils.getUserIdx
import com.debri_main.debri.data.post.EditPost
import com.debri_main.debri.data.post.PostDetail
import com.debri_main.debri.service.BoardService
import com.debri_main.debri.view.board.BoardListView
import com.debri_main.debri.view.post.EditPostView
...
class PostCreateActivity : AppCompatActivity(), PostCreateView, EditPostView, BoardListView {
    ...
    //spinner
    private val items = ArrayList<com.debri_main.debri.data.board.Board>()
    ...
    override fun onBoardListSuccess(code: Int, result: List<Board>) {
        when(code){
            200->{
                ...
                for (i in result){
                    items.add(com.debri_main.debri.data.board.Board(i.boardIdx, i.boardName))
                }
