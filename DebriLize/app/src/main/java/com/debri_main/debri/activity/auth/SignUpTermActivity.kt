...
import com.debri_main.debri.databinding.ActivitySignupTermBinding
import kotlin.properties.Delegates

class SignUpTermActivity: AppCompatActivity() {
    lateinit var binding: ActivitySignupTermBinding
    var agreeIdx by Delegates.notNull<Int>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        agreeIdx = intent.getIntExtra("agreeIdx", 0)

        if(agreeIdx==2){ //이용약관 (필수)
            binding.signUpTermTv2.text = "개인정보 약관"
            binding.signUpTermTv.text = "제 1 장 총칙\n" +
                    "제 1 조 (목적)\n" +
                    "이 약관은「데브리」(이하 “사이트”라 칭함)에서 제공하는 인터넷관련서비스(이하 \"서비스\"라 칭함)를 이용함에 있어 「데브리」와 이용자의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.\n" +
                    "제 2 조 (용어의 정의)\n" +
                    "이 약관에서 사용하는 주요한 용어의 정의는 다음과 같습니다.\n" +
                    "① ‘회원’이라 함은 이 약관에 동의하고, 「데브리」와 서비스 이용 계약을 체결하여 이용자 아이디(ID)를 부여 받은 개인 및 기관을 말합니다.\n" +
                    "② ‘회원 아이디’(이하 ‘ID’라 칭함)라 함은 회원의 식별과 회원의 서비스 이용을 위하여 회원이 선정하고 신청함에 따라 「데브리」에서 승인한 문자나 숫자 혹은 그 조합을 말합니다. 기관의 정보로 가입한 ID는 관련 법규가 인정하는 범위에서 개인정보와 같은 권리와 의무를 가지며 이하 개인과 개인정보로 언급되는 모든 약관은 기관과 기관정보를 포함합니다.\n" +
            ...
            binding.signUpTermTv2.text = "서비스 홍보 약관"
            binding.signUpTermTv.text = "서비스 홍보 약관\n" +
                    "상품소개 등을 위한 개인정보의 처리 동의(선택) \n" +
                    "① 소비자권익보호에 관한 사항 \n" +
                    " 동의거부권 및 유의사항 「데브리」를 통한 각종 이벤트 참여, 부가서비스 및 신상품 안내 등을 제공받고자 하시는 경우 동의해 주시기 바라며, 이에 대한 동의가 없더라도 「데브리」 회원 가입이 가능함을 알려드립니다. \n" +
                    "개인정보 제공동의 철회 개인정보 제공 및 이용에 동의한 이후에도 「데브리」 등을 통해 개인정보의 제공 동의를 철회 할 수 있습니다. \n" +
                    "서비스 홍보 중지청구 개인정보 제공 및 이용에 동의한 이후에도 「데브리」 등을 통해 마케팅활동에 대한 중지를 요청 할 수 있습니다. \n" +
                    "연락 중지 청구는 해당 이메일(DebriDevelopmentTeam@gmail.com) 을 통해서 이메일를 통한마케팅 연락중지를 신청할 수 있습니다. \n" +
                    "\n" +
                    "② 마케팅을 위한 개인(신용)정보 수집 및 이용 동의 \n" +
                    "당사는 개인정보보호법 및 정보통신망 이용촉진 및 정보보호 등에 관한 법률 등에 따라 상품 및 서비스 소개와 홍보 등 영업목적을 위하여 귀하의 개인정보를 다음과 같이 수집·이용하고자 합니다.\n" +
                    "1. 수집 및 이용목적 ·상담신청에 대한 응대를 통한 유익한 정보의 제공, 「데브리」 버전 업데이트에 따른 서비스 변경 내역 등 「데브리」의 정상적인 서비스에 관계된 행위 \n" +
                    "2. 수집 및 이용하는 개인정보 항목 ·이름, 생년월일, 성별, 회원ID, 비밀번호, 이메일\n" +
                    "3. 보유 및 이용기간 등 ·보유 및 이용기간 : 2년 ·서비스 업데이트 내역 등을 위한 연락방법 : 이메일"
        }

        //agree
        binding.agreeBtn.setOnClickListener {
            if(agreeIdx == 2){ //이용약관 (필수)
                SignUpActivity.Singleton.agree2TermCheck = true
                SignUpActivity.Singleton.agree2TF = true
            }else{ //이용약관 (선택)
                SignUpActivity.Singleton.agree3TermCheck = true
                SignUpActivity.Singleton.agree3TF = true
            }
            finish()
        }
